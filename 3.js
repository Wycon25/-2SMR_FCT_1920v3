...
function nacimiento (){
	...
	if (msFechaSeleccionada > msFechaActual || anio < 1920 || dia > ultimoDiaMes.getDate() || edad < 18) {
...
function carne (){
	...
	if (msFechaSeleccionada > msFechaActual || anio < 1938 || dia > fechaSeleccionada.getDate()) {
